...
<div class="service-section section pb-75 pb-md-65 pb-sm-45 pb-xs-25">
    <div class="container">
       
        <div class="row">
            <div class="section-title text-center col mb-60 mb-md-50 mb-sm-50 mb-xs-50">
...
<div class="choose-section section pb-80 pb-md-55 pb-sm-45 pb-xs-20">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="about-content col-lg-7 col-md-7 col-12 ">
                <h2>We never compromize <br> with quality work...</h2>
                <p>Ortiz is one of the most popular real estate company all around USA. You can find your dream property or build property </p>
                ...
                <div class="row row-25">
                    ...
                    <div class="about-feature col-md-6  col-sm-6 col-12 mb-35">
                        ...
                        <div class="content-two">
                            ...
                            <p>Paint is the mirron of beauty dream house build property with us </p>
                        </div>
                    </div>
                    ...
                    <div class="about-feature col-md-6  col-sm-6 col-12 mb-35">
                        ...
                        <div class="content-two">
                            ...
                            <p>Well decorated and fully furnished properties is available for all</p>
                        </div>
                    </div>
                    ...
                    <div class="about-feature col-md-6  col-sm-6 col-12 mb-35">
                        ...
                        <div class="content-two">
                            ...
                            <p>All interior are latest and luxurious mirron of beauty dream house </p>
                        </div>
                    </div>
                    ...
                    <div class="about-feature col-md-6  col-sm-6 col-12 mb-35">
                        ...
                        <div class="content-two">
                            ...
                            <p>Security in our property area is the main priority for our all cusotmer</p>
                        </div>
                    </div>
...
<div class="our-agents-section section pb-110 pb-md-90 pb-xs-60 pb-sm-70">
    <div class="container">
       
        <div class="row">
            <div class="section-title text-center col mb-30 mb-md-20 mb-xs-20 mb-sm-20">
                <h2>Nuestros Agentes</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus doloremque voluptatum, quis, labore a cumque dignissimos in quod officia.</p>
            </div>
        </div>
        
        <div class="row">
             <?php echo rst_listar_agentes(4); ?>
        </div>
...
<div class="testimonial-section section pt-110 pt-md-90 pt-xs-60 pt-sm-70 testimonial-bg">
    <div class="container">
